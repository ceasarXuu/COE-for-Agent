...
>
> 当前状态：截至 2026-04-07，仓库已经完成可运行、可演示、可验证的 MVP 主链路，但还不是生产化收口版本。
...
这个仓库现在适合开发、演示、验证和继续扩展，但还不应该被描述成“生产化平台”。
...
- 完整 CI/CD 与发布流程
- 大规模场景下的性能与容量治理
- 超出 MVP 范围的跨 agent 协议层扩展，例如 A2A facade
...
- PostgreSQL 和 OTel Collector 会通过 Docker Compose 启动
