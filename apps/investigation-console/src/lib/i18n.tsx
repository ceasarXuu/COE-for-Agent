...
const MESSAGES: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'root.cases': 'Cases',
    'cases.galleryKicker': 'Case gallery',
    'cases.galleryTitle': 'Manual intake and active investigations',
    'cases.galleryCopy': 'Start a fresh case from the first card, then move through active investigations as a visual gallery.',
    ...
    'caseCreate.kicker': 'Manual intake',
    'caseCreate.title': 'Create a new case',
    'caseCreate.copy': 'Open a fresh investigation branch with enough context for the workspace to become useful immediately.',
    'caseCreate.close': 'Close',
    'caseCreate.submit': 'Create case',
    'caseCreate.submitting': 'Creating…',
    'caseCreate.cancel': 'Cancel',
    'caseCreate.galleryKicker': 'Manual intake',
    ...
    'caseCreate.sidecarKicker': 'First revision',
    'caseCreate.sidecarCopy': 'A new case opens in intake with a default inquiry so you can move straight into the workspace.',
  ...
  'zh-CN': {
    ...
    'root.title': '调查控制台',
    'root.cases': '案件',
    'cases.galleryKicker': '案件画廊',
    'cases.galleryTitle': '手动受理与进行中的调查',
    'cases.galleryCopy': '第一张卡片固定用于新建 case，后面的卡片按画廊方式展示正在推进的调查。',
    'cases.search': '检索记录',
    ...
    'caseCreate.kicker': '手动受理',
    'caseCreate.title': '新建案件',
    'caseCreate.copy': '用一条完整但轻量的受理信息开启新调查，让工作台一进来就有上下文。',
    'caseCreate.close': '关闭',
    'caseCreate.submit': '创建案件',
    'caseCreate.submitting': '创建中…',
    'caseCreate.cancel': '取消',
    'caseCreate.galleryKicker': '手动受理',
    ...
    'caseCreate.sidecarKicker': '首个修订',
    'caseCreate.sidecarCopy': '新 case 会以 intake 阶段创建，并自动带上默认 inquiry，方便立即进入工作台。',
