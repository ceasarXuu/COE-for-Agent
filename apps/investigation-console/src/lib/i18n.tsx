...
const MESSAGES: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'inspector.problem.primary': 'Hypotheses',
    'inspector.problem.secondary': 'Context',
    'inspector.problem.primaryEmpty': 'No hypotheses have been created yet.',
    'inspector.problem.secondaryEmpty': 'No extra context is attached yet.',
    'inspector.blocker.primary': 'Blocked branch',
    'inspector.blocker.secondary': 'Workarounds',
    'inspector.blocker.primaryEmpty': 'No blocked branch is linked yet.',
    'inspector.blocker.secondaryEmpty': 'No workaround has been recorded.',
    'inspector.repairAttempt.primary': 'Validation evidence',
    'inspector.repairAttempt.secondary': 'Follow-on attempts',
    'inspector.repairAttempt.primaryEmpty': 'No validation evidence is attached yet.',
    'inspector.repairAttempt.secondaryEmpty': 'No follow-on repair attempts are linked yet.',
    'inspector.evidenceRef.primary': 'Evidence details',
    'inspector.evidenceRef.secondary': 'Used by',
    'inspector.evidenceRef.primaryEmpty': 'No evidence metadata is available yet.',
    'inspector.evidenceRef.secondaryEmpty': 'No related branch context is linked yet.',
    ...
    'graph.newIssue': 'New issue',
    'graph.newArtifact': 'New artifact',
    ...
    'graph.node.issue': 'Issue',
    'graph.node.artifact': 'Artifact',
    'graph.node.fact': 'Fact',
    'graph.node.hypothesis': 'Hypothesis',
    'graph.node.experiment': 'Experiment',
  ...
  'zh-CN': {
    ...
    'inspector.problem.primary': '假设分支',
    'inspector.problem.secondary': '上下文',
    'inspector.problem.primaryEmpty': '还没有创建任何假设分支。',
    'inspector.problem.secondaryEmpty': '还没有附加额外上下文。',
    'inspector.blocker.primary': '受阻分支',
    'inspector.blocker.secondary': '可行绕过方案',
    'inspector.blocker.primaryEmpty': '还没有关联受阻分支。',
    'inspector.blocker.secondaryEmpty': '还没有记录绕过方案。',
    'inspector.repairAttempt.primary': '验证证据',
    'inspector.repairAttempt.secondary': '后续修复尝试',
    'inspector.repairAttempt.primaryEmpty': '还没有挂接验证证据。',
    'inspector.repairAttempt.secondaryEmpty': '还没有关联后续修复尝试。',
    'inspector.evidenceRef.primary': '证据详情',
    'inspector.evidenceRef.secondary': '关联分支',
    'inspector.evidenceRef.primaryEmpty': '还没有可展示的证据元数据。',
    'inspector.evidenceRef.secondaryEmpty': '还没有关联分支上下文。',
