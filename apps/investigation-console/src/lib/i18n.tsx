...
const MESSAGES: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'caseCreate.fields.environment': 'Environment',
    ...
    'caseCreate.placeholders.environment': 'prod-us-1, worker-cluster',
    'caseCreate.placeholders.labels': 'manual, regression, customer-impact',
    'caseCreate.hints.environment': 'Separate multiple environments with commas.',
    'caseCreate.hints.labels': 'Use labels for intake source, severity theme, or owning area.',
    'caseCreate.preview.environment': 'Environment preview',
    ...
    'graph.clearFocus': 'Return to full graph',
  ...
  'zh-CN': {
    ...
    'caseCreate.fields.environment': '环境',
    ...
    'caseCreate.placeholders.environment': 'prod-us-1, worker-cluster',
    'caseCreate.placeholders.labels': 'manual, regression, customer-impact',
    'caseCreate.hints.environment': '多个环境用逗号分隔。',
    'caseCreate.hints.labels': '可用于标记来源、问题主题或责任域。',
    'caseCreate.preview.environment': '环境预览',
